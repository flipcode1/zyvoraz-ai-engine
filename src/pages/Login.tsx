      ...
      <div className="hidden lg:flex flex-1 items-center justify-center relative overflow-hidden">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-md">
            Your AI-powered global selling engine. Turn ideas into income with Zyvoraz.
          </p>
        </motion.div>
      </div>
        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full gradient-bg text-primary-foreground font-semibold h-12 text-base glow-shadow hover:opacity-90 transition-opacity"
            >
